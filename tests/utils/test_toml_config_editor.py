...
def test_inject_tool_config_in_file_add_new(tmp_path):
    ...
    inject_tool_config_in_file(pyproject_path, "black", black_conf, update_if_exists=False, dry_run=False)
...
"""
    ...
    inject_tool_config_in_file(pyproject_path, "black", black_conf, update_if_exists=True, dry_run=False)
