...
def test_full_pre_commit_workflow(tmp_path):
    ...
    manager.add_hook("https://github.com/pre-commit/pre-commit-hooks", "v4.4.0", pre_commit_hooks)
    ...
    expected_hooks = {
        ...
        "check-added-large-files", "black", "isort", "flake8"
    }
...
def test_configuration_persistence_and_reload(tmp_path):
    ...
    manager2.add_hook("https://github.com/pre-commit/pre-commit-hooks", "v4.4.0", [
        {"id": "trailing-whitespace"}
    ])
    manager2.save()
...
""")
    ...
    manager.add_hook("https://github.com/pre-commit/pre-commit-hooks", "v4.4.0", [
        {"id": "trailing-whitespace"}
    ])
...
def test_large_configuration_management(tmp_path):
    ...
    repositories = [
        ...
        ("https://github.com/psf/black", "v22.0.0", [
            {"id": "black", "language_version": "python3.9"}
        ]),
        ("https://github.com/pycqa/isort", "v5.12.0", [
            {"id": "isort", "args": ["--profile", "black"]}
        ]),
        ("https://github.com/pycqa/flake8", "v6.0.0", [
            {"id": "flake8", "args": ["--max-line-length=88"]}
        ]),
        ("https://github.com/pre-commit/mirrors-mypy", "v1.0.0", [
    ...
    expected_hooks = {
        "trailing-whitespace", "end-of-file-fixer", "check-yaml",
        "check-added-large-files", "check-merge-conflict", "black",
        "isort", "flake8", "mypy"
    }
    assert set(all_hooks) == expected_hooks
